...
export const EmptyUncategorizedState = ({ className }: { className?: string }) => {
  return (
    <div className="flex flex-col h-80 justify-center items-center">
      <TagsIcon className="text-primary w-10 h-10" />
      <h3 className="text-primary mt-3 tracking-wide font-medium">
      ...
      <p className="mt-1 text-sm text-muted-foreground text-center">
        New URLs without tag will appear here.
      </p>
    </div>
  );
};
...
export const PriceCheckIcon = ({ className }: { className: string }) => (
  <svg
    className={`${className} mr-1.5`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    width={19}
    height={19}
...
export const UncategorizedIcon = ({
  className,
  isActive,
}: {
  className?: string;
